...
class Renderer
{
	public:
		...
		void DrawIndexedTextureAtlas(Texture &texture, Texture &palette, const glm::vec2& clipPos, const glm::vec2& clipSize, bool rotated, const glm::vec2& position, bool flipped = false, bool flippedVert = false ,const glm::vec4& color = glm::vec4(1.0f));
